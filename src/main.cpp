...
bool parseOptions(int argc, char** argv, openblack::Arguments& args, int& returnCode)
{
	...
	static constexpr std::string_view k_DefaultLogFile =
	...
	options.add_options()
		...
		("l,log-file", "Output file for logs, 'stdout'/'logcat' for terminal output.", cxxopts::value<std::string>()->default_value(k_DefaultLogFile.data()))
